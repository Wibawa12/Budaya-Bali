...
@section('content')
    ...
    <section class="konten mt-8 mb-5 mr-6 ml-6">
        <div class="text-left text-justify m-2 mb-4">
    ...
    <!-- Form Hubungi kami -->
    <section class="bg-gray-100 py-12" id="hubungi-kami">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" data-aos="zoom-in-up" data-aos-duration="900">
